...
-- Time: 08:15:08
-- By Wesley
--CREATE OR ALTER VIEW V_INTEGRACAO_SCMI_X_EPIMED (MEDICALRECORD, DOCUMENTTYPECODE, DOCUMENTNUMBER, PATIENTNAME, GENDER, BIRTHDATE, HOSPITALHEALTHINSURANCECODE, HOSPITALCODE, HOSPITALADMISSIONNUMBER, HOSPITALADMISSIONDATE, UNITCODE, UNITADMISSIONNUMBER, UNITADMISSIONDATETIME, BEDCODE, DISCHARGECAUSE, HOSPITALDISCHARGEDATE, MEDICALDISCHARGEDATE, CREATEDATE, ADDRESS, TELEPHONE)
--AS
SELECT
